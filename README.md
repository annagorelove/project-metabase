...
## Гипотезы
- **Лояльность и частота покупок** — Клиенты, которые покупали 2+ раза за последние 3–6 месяцев, с большей вероятностью откликнутся на персональную скидку.
- **Средний чек и потенциал роста** — Персональная скидка эффективнее для клиентов со средним чеком выше определенного порога (3000р.), так как они склонны к более крупным покупкам.
- **Давность последней покупки** — Чем меньше дней с момента последней покупки, тем выше вероятность отклика на рассылку.
- **Исключение одноразовых покупателей** — Клиенты с одной мелкой покупкой не принесут значимого роста выручки даже при скидке.
- **Гипотезы на основе RFM** — Клиенты с высокой частотой покупок более лояльны и чаще реагируют на персональные предложения; клиенты с высоким M и удовлетворительным R/F формируют основную часть прибыли аптечной сети; клиенты с высокими оценками R и F чаще совершают покупки и могут быть вовлечены в программы лояльности, бонусные карты.
- **Гипотезы на основе сезонности и удержания** — Клиенты, чьи покупки приходятся на текущий сезон, с большей вероятностью купят снова при напоминании; клиенты с высоким риском ухода нуждаются в срочном персональном предложении.
